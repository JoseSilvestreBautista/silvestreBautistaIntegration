...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Hello, I am your virtual assisant ");
    System.out.println("but first I need to get some infomation.");
    ...
    System.out.print("Half your age is " + halfAge);
 ...
 *  minimum value of -128 and a maximum value of 127 (inclusive). Good for 
 *  saving memory.
 */
...
/*
 * int: By default, the int data type is a 32-bit. has a minimum value of -231
 * and a maximum value of 231-1. use int data type as an unsigned integer
 */

/*
 * long: The long data type is a 64-bit. has a minimum value of -263 and a 
 * maximum value of 263-1.when you need a range of values wider than those 
 * provided by int.
 */

/*
 * float: The float data type is a single-precision 32-bit IEEE 754 floating 
 * point. Good for saving memory, not for precision
 */

/*
 * The double data type is a double-precision 64-bit IEEE 754 floating point.
 * Usually default choice for decimals, mot good for precision.
 */
 ...
 * minimum value of 0 and a maximum value of  65,535 inclusive.
 */
